...
const TreeContext = /** @class */ (function () {
...
const Tree = /** @class */ (function () {
  function Tree(container, configuration, options) {
    ...
    options.showTwistie = options.showTwistie !== false;
    options.indentPixels = typeof options.indentPixels === 'number' ? options.indentPixels : 12;
    options.alwaysFocused = options.alwaysFocused === true;
    options.useShadows = options.useShadows !== false;
    options.paddingOnRow = options.paddingOnRow !== false;
