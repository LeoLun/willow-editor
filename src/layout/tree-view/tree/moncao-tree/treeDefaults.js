...
const KeybindingDispatcher = /** @class */ (function () {
...
const DefaultController = /** @class */ (function () {
  function DefaultController(options) {
    ...
    if (typeof options.keyboardSupport !== 'boolean' || options.keyboardSupport) {
      this.downKeyBindingDispatcher.set(16 /* UpArrow */, (t, e) => _this.onUp(t, e));
      this.downKeyBindingDispatcher.set(18 /* DownArrow */, (t, e) => _this.onDown(t, e));
      this.downKeyBindingDispatcher.set(15 /* LeftArrow */, (t, e) => _this.onLeft(t, e));
      this.downKeyBindingDispatcher.set(17 /* RightArrow */, (t, e) => _this.onRight(t, e));
      if (platform.isMacintosh) {
        this.downKeyBindingDispatcher.set(2048 /* CtrlCmd */ | 16 /* UpArrow */, (t, e) => _this.onLeft(t, e));
        this.downKeyBindingDispatcher.set(256 /* WinCtrl */ | 44 /* KEY_N */, (t, e) => _this.onDown(t, e));
        this.downKeyBindingDispatcher.set(256 /* WinCtrl */ | 46 /* KEY_P */, (t, e) => _this.onUp(t, e));
      }
      this.downKeyBindingDispatcher.set(11 /* PageUp */, (t, e) => _this.onPageUp(t, e));
      this.downKeyBindingDispatcher.set(12 /* PageDown */, (t, e) => _this.onPageDown(t, e));
      this.downKeyBindingDispatcher.set(14 /* Home */, (t, e) => _this.onHome(t, e));
      this.downKeyBindingDispatcher.set(13 /* End */, (t, e) => _this.onEnd(t, e));
      this.downKeyBindingDispatcher.set(10 /* Space */, (t, e) => _this.onSpace(t, e));
      this.downKeyBindingDispatcher.set(9 /* Escape */, (t, e) => _this.onEscape(t, e));
  ...
  DefaultController.prototype.onLeftClick = function (tree, element, eventish, origin) {
    ...
    const payload = { origin, originalEvent: eventish, didClickOnTwistie: this.isClickOnTwistie(event) };
  ...
  DefaultController.prototype.onLeft = function (tree, event) {
    ...
    if (tree.getHighlight()) {
      ...
      const focus_1 = tree.getFocus();
      tree.collapse(focus_1).then((didCollapse) => {
  ...
  DefaultController.prototype.onRight = function (tree, event) {
    ...
    if (tree.getHighlight()) {
      ...
      const focus_2 = tree.getFocus();
      tree.expand(focus_2).then((didExpand) => {
...
const DefaultDragAndDrop = /** @class */ (function () {
...
const DefaultFilter = /** @class */ (function () {
...
const DefaultAccessibilityProvider = /** @class */ (function () {
...
const DefaultTreestyler = /** @class */ (function () {
